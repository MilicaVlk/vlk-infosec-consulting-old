...
window.VLKVerification=(()=>{
 ...
 form.querySelector('#enquiry-submit').before(box);
 ...
 box.querySelector('#new-code').addEventListener('click',reset);
 ...
 return {async submit(fields){
  ...
  try{
   ...
   done=true;entry.hidden=true;form.querySelector('#enquiry-submit').disabled=true;
